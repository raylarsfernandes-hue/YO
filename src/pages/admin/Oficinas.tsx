...
const empty: Omit<Workshop, 'id' | 'created_at'> = {
  name: '', teacher: '', event_day: '2026-10-24', start_time: '14:00',
  duration_minutes: 70, max_vagas: 30, active: true, order_index: 0,
}
...
export default function Oficinas() {
  ...
  function startEdit(w: Workshop) {
    setEditingId(w.id)
    setForm({
      name: w.name, teacher: w.teacher, event_day: w.event_day, start_time: w.start_time,
  ...
  return (
    <div>
      ...
      <p style={{ opacity: 0.6, fontSize: 14, marginBottom: 20 }}>
        Edite nome, professor(a), data, horário e número de vagas. Alterações refletem imediatamente no site.
      </p>
